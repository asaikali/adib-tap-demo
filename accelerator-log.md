...
```json
{
  "projectName" : "adib-tap-demo",
  "repositoryPrefix" : "us-docker.pkg.dev/fe-asaikali/iterate-apps"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->adib-tap-demo]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].merge.transformations[0].sources[1].<combo>.transformations[1].transformations[1] (ReplaceText)
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->us-docker.pkg.dev/fe...(truncated)]
